...
class apple: 
    ...
    def setup_calculation_menu(self):
        ...
        self.submit_lines.pack(pady=(0,0))
        ...
        self.example_line.pack(pady=(0,10), fill=tk.X)
        ...
        if os.path.exists(self.image_path):
            ...
            self.image_line.pack(pady=(0,50))

        def x_y_start(self):
            line_number = tk.IntVar(value=1)
            ...
            def y_input(event=None):
                ...
                if result is not None:
                    ...
                    if int(coordinate_point.get()) >= 2:
                        ...
                        self.xinstructions.config(text=f"Please input {int(coordinate_point.get())}st 'X' coordinate for line {int(line_number.get())}.")
                    else:
                        coordinate_point.set(coordinate_point.get() + 1)
                        self.xinstructions.config(text=f"Please input {int(coordinate_point.get())}nd 'X' coordinate for line {int(line_number.get())}.")
            ...
            def x_input(event=None):
                ...
                if result is not None:
                    ...
                    self.line_image_frame.pack()
                    if int(coordinate_point.get()) >= 2:
                        self.yinstructions.config(text=f"Please input {int(coordinate_point.get())}nd 'Y' coordinate for line {int(line_number.get())}.")
                    else:
                        self.yinstructions.config(text=f"Please input {int(coordinate_point.get())}st 'Y' coordinate for line {int(line_number.get())}.")
            ...
            self.yinstructions = self.WrappingLabel(
                y_container,
                text=f"Please input {int(coordinate_point.get())}st 'Y' coordinate for line {int(line_number.get())}.",
            )
            ...
            self.submit_y.pack(pady=(0,0))
            y_container.pack_forget()

            self.xinstructions = self.WrappingLabel(
                x_container,
                text=f"Please input {int(coordinate_point.get())}st 'X' coordinate for line {int(line_number.get())}.",
            )
    ...
    def calculation_menu(self):
        ...
        self.line_image_frame.pack(pady=(0,0))
